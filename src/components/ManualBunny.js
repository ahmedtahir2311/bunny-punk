  ...
  return (
    <div style={{width: 350, marginBottom: 50}}>
      <div style={{backgroundColor: "rgb(23, 53, 96)", borderTopRightRadius: 24, borderTopLeftRadius: 24, display: "flex", justifyContent: "space-between", padding: 24}}>
        <div>
          <span style={{fontSize: 24, fontWeight: 600, color: "rgb(242, 92, 35)"}}>Manual Bunny</span><br/>
      ...
      <div style={{padding: 24, backgroundColor: "rgb(14, 23, 48)", borderBottomRightRadius: 24, borderBottomLeftRadius: 24}}>
        ...
        <div style={{display: "flex", margin: "24px 0px", justifyContent: "space-between"}}>
          <div>
            <span style={{fontSize: 15, fontWeight: 600}}><span style={{color: "rgb(242, 92, 35)"}}>BUNNY</span> <span style={{color: "rgb(173, 182, 210)"}}>Earned</span></span><br/>
        ...
        <div style={{display: "flex", margin: "24px 0px", justifyContent: "space-between"}}>
          <div>
            ...
            <span style={{color: "rgb(96, 100, 113)", fontSize: 20, fontWeight: 600}}>{props.depositAmount}</span><br/>
            {/* <span style={{color: "rgb(96, 100, 113)", fontSize: 16, fontWeight: 600}}>0 USD</span> */}
          </div>
          ...
          true
            ...
            :
              <div>
                ...
                <button disabled={props.isEnabling} onClick={()=>props.onClickEnable("BUNNY")} style={{height: 48, marginTop: 5, display: "flex", justifyContent: "center", alignItems: "center", width: "100%", borderRadius: 16, padding: "0px 24px", backgroundColor: "rgb(242, 92, 35)", cursor: "pointer", outline: "none", border: "none"}}>
                  <span style={{fontSize: 20, fontWeight: 400, color: "white"}}>{props.isEnabling==="BUNNY" ? "Loading..." : "Enable"}</span>
                </button>
              </div>
        }
